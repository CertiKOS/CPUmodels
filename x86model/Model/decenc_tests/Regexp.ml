...
| Coq_rEps -> (Obj.magic ()) :: []
| Coq_rCat (ag1, ag2) -> Obj.magic list_prod (regexp_extract_nil ag1) (regexp_extract_nil ag2)
| Coq_rAlt (ag1, ag2) ->
  app (map (fun x -> Obj.magic (Coq_inl x)) (regexp_extract_nil ag1)) (map (fun x -> Obj.magic (Coq_inr x)) (regexp_extract_nil ag2))
