...
module X86_RTL :
 sig
  ...
  val bit_vector_op_rect : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> bit_vector_op -> 'a1

  val bit_vector_op_rec : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> bit_vector_op -> 'a1
  ...
  | Coq_get_array_rtl_exp of Big.big_int * Big.big_int * X86_MACHINE.array * rtl_exp
  ...
  val rtl_exp_rect :
    ...
    Big.big_int -> rtl_exp -> 'a1 -> 'a1) -> (Big.big_int -> RTL.int -> 'a1) -> (Big.big_int -> X86_MACHINE.location -> 'a1) -> (Big.big_int -> pseudo_reg
    -> 'a1) -> (Big.big_int -> Big.big_int -> X86_MACHINE.array -> rtl_exp -> 'a1 -> 'a1) -> (rtl_exp -> 'a1 -> 'a1) -> (Big.big_int -> 'a1) ->
    (Big.big_int -> Big.big_int -> __ -> float_arith_op -> rtl_exp -> 'a1 -> rtl_exp -> 'a1 -> rtl_exp -> 'a1 -> 'a1) -> (Big.big_int -> Big.big_int ->
    Big.big_int -> Big.big_int -> __ -> __ -> rtl_exp -> 'a1 -> rtl_exp -> 'a1 -> 'a1) -> Big.big_int -> rtl_exp -> 'a1
  ...
  | Coq_set_array_rtl of Big.big_int * Big.big_int * X86_MACHINE.array * rtl_exp * rtl_exp
  ...
  val rtl_instr_rect :
    (Big.big_int -> rtl_exp -> X86_MACHINE.location -> 'a1) -> (Big.big_int -> rtl_exp -> pseudo_reg -> 'a1) -> (Big.big_int -> Big.big_int ->
    X86_MACHINE.array -> rtl_exp -> rtl_exp -> 'a1) -> (rtl_exp -> rtl_exp -> 'a1) -> 'a1 -> (rtl_exp -> rtl_instr -> 'a1 -> 'a1) -> 'a1 -> 'a1 ->
    rtl_instr -> 'a1
  ...
  type oracle = { oracle_bits : (Big.big_int -> Big.big_int -> RTL.int); oracle_offset : Big.big_int }
  ...
  type rtl_state = { rtl_oracle : oracle; rtl_env : pseudo_env; rtl_mach_state : X86_MACHINE.mach_state; rtl_memory : int8 AddrMap.t }
  ...
  val update_ps_env : Big.big_int -> pseudo_reg -> RTL.int -> pseudo_env -> pseudo_env
  ...
  val set_array : Big.big_int -> Big.big_int -> X86_MACHINE.array -> RTL.int -> RTL.int -> unit coq_RTL

  val set_byte : RTL.int -> RTL.int -> unit coq_RTL

  val advance_oracle : unit coq_RTL

  val interp_arith : Big.big_int -> bit_vector_op -> RTL.int -> RTL.int -> RTL.int
  ...
  val interp_farith : Big.big_int -> Big.big_int -> float_arith_op -> RTL.int -> RTL.int -> RTL.int -> RTL.int

  val cond_Zopp : bool -> Big.big_int -> Big.big_int

  val binary_float_cast : Big.big_int -> Big.big_int -> Big.big_int -> Big.big_int -> RTL.int -> rtl_float -> rtl_float

  val interp_fcast : Big.big_int -> Big.big_int -> Big.big_int -> Big.big_int -> RTL.int -> RTL.int -> RTL.int
  ...
  val get_array : Big.big_int -> Big.big_int -> X86_MACHINE.array -> RTL.int -> RTL.int coq_RTL
...
module X86_Compile :
 sig
  ...
  val conv_MOV_extend : (Big.big_int -> Big.big_int -> X86_RTL.rtl_exp -> X86_RTL.rtl_exp coq_Conv) -> prefix -> bool -> operand -> operand -> unit coq_Conv
