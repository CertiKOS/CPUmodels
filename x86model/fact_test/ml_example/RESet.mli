...
module Raw :
 sig
  ...
  | R_inter_0 of tree * tree
  | R_inter_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
  | R_inter_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * t * 
     tree * coq_R_inter * tree * coq_R_inter
  | R_inter_3 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * t * 
     tree * coq_R_inter * tree * coq_R_inter

  type coq_R_diff = RawRESet.Raw.coq_R_diff =
  | R_diff_0 of tree * tree
  | R_diff_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
  | R_diff_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * t * 
     tree * coq_R_diff * tree * coq_R_diff
  | R_diff_3 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * t * 
     tree * coq_R_diff * tree * coq_R_diff

  type coq_R_union = RawRESet.Raw.coq_R_union =
  | R_union_0 of tree * tree
  | R_union_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
  | R_union_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * t * 
