 ...
 sig
  module type RESETXFORM =
   sig
    ...
    val fold_xform : xtype -> (re_xf_pair -> 'a1 -> 'a1) -> rs_xf_pair -> 'a1 -> 'a1
   ...
   sig
    module Raw :
     sig
      ...
      val elements_aux : REOrderedTypeAlt.t list -> tree -> REOrderedTypeAlt.t list

      val elements : tree -> REOrderedTypeAlt.t list

      val rev_elements_aux : REOrderedTypeAlt.t list -> tree -> REOrderedTypeAlt.t list
      ...
      val compare_more : REOrderedTypeAlt.t -> (enumeration -> comparison) -> enumeration -> comparison
      ...
      | R_min_elt_2 of tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * elt option
         * coq_R_min_elt

      type coq_R_max_elt = RawRESet.Raw.coq_R_max_elt =
      | R_max_elt_0 of tree
      | R_max_elt_1 of tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_max_elt_2 of tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * elt option
         * coq_R_max_elt
      ...
      | R_bal_1 of t * REOrderedTypeAlt.t * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_bal_2 of t * REOrderedTypeAlt.t * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_bal_3 of t * REOrderedTypeAlt.t * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_bal_4 of t * REOrderedTypeAlt.t * t
      | R_bal_5 of t * REOrderedTypeAlt.t * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_bal_6 of t * REOrderedTypeAlt.t * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_bal_7 of t * REOrderedTypeAlt.t * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_bal_8 of t * REOrderedTypeAlt.t * t

      type coq_R_remove_min = RawRESet.Raw.coq_R_remove_min =
      | R_remove_min_0 of tree * elt * t
      | R_remove_min_1 of tree * elt * t * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * (t * elt) * coq_R_remove_min * t * elt

      type coq_R_merge = RawRESet.Raw.coq_R_merge =
      | R_merge_0 of tree * tree
      | R_merge_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_merge_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * elt

      type coq_R_concat = RawRESet.Raw.coq_R_concat =
      | R_concat_0 of tree * tree
      | R_concat_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_concat_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * elt

      type coq_R_inter = RawRESet.Raw.coq_R_inter =
      | R_inter_0 of tree * tree
      | R_inter_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_inter_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * 
         t * tree * coq_R_inter * tree * coq_R_inter
      | R_inter_3 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * 
         t * tree * coq_R_inter * tree * coq_R_inter

      type coq_R_diff = RawRESet.Raw.coq_R_diff =
      | R_diff_0 of tree * tree
      | R_diff_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_diff_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * 
         t * tree * coq_R_diff * tree * coq_R_diff
      | R_diff_3 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * 
         t * tree * coq_R_diff * tree * coq_R_diff

      type coq_R_union = RawRESet.Raw.coq_R_union =
      | R_union_0 of tree * tree
      | R_union_1 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree
      | R_union_2 of tree * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * Int.Z_as_Int.t * tree * REOrderedTypeAlt.t * tree * t * bool * 
  ...
  module Raw :
   sig
    ...
    type triple = RESet.RawRESet.Raw.triple = { t_left : t; t_in : bool; t_right : t }
  ...
  val create_xform : xtype -> Raw.tree -> xform -> regexp -> xform -> Raw.tree -> xform -> tree_xf_pair
  ...
  val ctxt_rect :
    'a1 -> (Int.Z_as_Int.t -> ctxt -> 'a1 -> REOrderedTypeAlt.t -> Raw.tree -> 'a1) -> (Int.Z_as_Int.t -> Raw.tree -> REOrderedTypeAlt.t -> ctxt -> 'a1 ->
    'a1) -> ctxt -> 'a1
  ...
  val assert_false_xform : xtype -> Raw.tree -> xform -> regexp -> xform -> Raw.tree -> xform -> tree_xf_pair

  val bal_xform : xtype -> Raw.tree -> xform -> regexp -> xform -> Raw.tree -> xform -> tree_xf_pair

  val add_xform_tree : xtype -> regexp -> xform -> Raw.tree -> xform -> Raw.tree*xform

  val join_xform : xtype -> Raw.tree -> xform -> regexp -> xform -> Raw.tree -> xform -> Raw.tree*xform

  type triple_xform = RESet.triple_xform = { t_left : Raw.tree; t_left_xform : xform; t_in : xform option; t_right : Raw.tree; t_right_xform : xform }
  ...
  val union_xform_tree : xtype -> Raw.tree -> xform -> Raw.tree -> xform -> Raw.tree*xform

  val add_xform : xtype -> re_xf_pair -> rs_xf_pair -> rs_xf_pair

  val union_xform : xtype -> rs_xf_pair -> rs_xf_pair -> rs_xf_pair

  val fold_tree_xform : xtype -> (re_xf_pair -> 'a1 -> 'a1) -> Raw.tree -> xform -> 'a1 -> 'a1

  val fold_xform : xtype -> (re_xf_pair -> 'a1 -> 'a1) -> rs_xf_pair -> 'a1 -> 'a1

  val map_xform : xtype -> xtype -> (re_xf_pair -> re_xf_pair) -> rs_xf_pair -> rs_xf_pair
 ...
 sig
  ...
  module P :
   sig
    ...
    val fold_rec :
      (RES.elt -> 'a1 -> 'a1) -> 'a1 -> RES.t -> (RES.t -> __ -> 'a2) -> (RES.elt -> 'a1 -> RES.t -> RES.t -> __ -> __ -> __ -> 'a2 -> 'a2) -> 'a2

    val fold_rec_bis :
      (RES.elt -> 'a1 -> 'a1) -> 'a1 -> RES.t -> (RES.t -> RES.t -> 'a1 -> __ -> 'a2 -> 'a2) -> 'a2 -> (RES.elt -> 'a1 -> RES.t -> __ -> __ -> 'a2 -> 'a2)
      -> 'a2

    val fold_rec_nodep : (RES.elt -> 'a1 -> 'a1) -> 'a1 -> RES.t -> 'a2 -> (RES.elt -> 'a1 -> __ -> 'a2 -> 'a2) -> 'a2

    val fold_rec_weak :
      (RES.elt -> 'a1 -> 'a1) -> 'a1 -> (RES.t -> RES.t -> 'a1 -> __ -> 'a2 -> 'a2) -> 'a2 -> (RES.elt -> 'a1 -> RES.t -> __ -> 'a2 -> 'a2) -> RES.t -> 'a2

    val fold_rel : (RES.elt -> 'a1 -> 'a1) -> (RES.elt -> 'a2 -> 'a2) -> 'a1 -> 'a2 -> RES.t -> 'a3 -> (RES.elt -> 'a1 -> 'a2 -> __ -> 'a3 -> 'a3) -> 'a3

    val set_induction : (RES.t -> __ -> 'a1) -> (RES.t -> RES.t -> 'a1 -> RES.elt -> __ -> __ -> 'a1) -> RES.t -> 'a1

    val set_induction_bis : (RES.t -> RES.t -> __ -> 'a1 -> 'a1) -> 'a1 -> (RES.elt -> RES.t -> __ -> 'a1 -> 'a1) -> RES.t -> 'a1
  ...
  module PP :
   sig
    ...
    val fold_rec : (MM.elt -> 'a1 -> 'a1) -> 'a1 -> MM.t -> (MM.t -> __ -> 'a2) -> (MM.elt -> 'a1 -> MM.t -> MM.t -> __ -> __ -> __ -> 'a2 -> 'a2) -> 'a2

    val fold_rec_bis :
      (MM.elt -> 'a1 -> 'a1) -> 'a1 -> MM.t -> (MM.t -> MM.t -> 'a1 -> __ -> 'a2 -> 'a2) -> 'a2 -> (MM.elt -> 'a1 -> MM.t -> __ -> __ -> 'a2 -> 'a2) -> 'a2

    val fold_rec_nodep : (MM.elt -> 'a1 -> 'a1) -> 'a1 -> MM.t -> 'a2 -> (MM.elt -> 'a1 -> __ -> 'a2 -> 'a2) -> 'a2

    val fold_rec_weak :
      (MM.elt -> 'a1 -> 'a1) -> 'a1 -> (MM.t -> MM.t -> 'a1 -> __ -> 'a2 -> 'a2) -> 'a2 -> (MM.elt -> 'a1 -> MM.t -> __ -> 'a2 -> 'a2) -> MM.t -> 'a2

    val fold_rel : (MM.elt -> 'a1 -> 'a1) -> (MM.elt -> 'a2 -> 'a2) -> 'a1 -> 'a2 -> MM.t -> 'a3 -> (MM.elt -> 'a1 -> 'a2 -> __ -> 'a3 -> 'a3) -> 'a3

    val set_induction : (MM.t -> __ -> 'a1) -> (MM.t -> MM.t -> 'a1 -> MM.elt -> __ -> __ -> 'a1) -> MM.t -> 'a1

    val set_induction_bis : (MM.t -> MM.t -> __ -> 'a1 -> 'a1) -> 'a1 -> (MM.elt -> MM.t -> __ -> 'a1 -> 'a1) -> MM.t -> 'a1
...
type transition_t = { row_num : Big.big_int; row_entries : entries_t; row_nils : xt_interp list }
...
type coq_DFA = { dfa_num_states : Big.big_int; dfa_states : wf_states; dfa_transition : transitions_t }
...
type vtransition_t = { vrow_num : Big.big_int; vrow_entries : ventries_t; vrow_nils : xt_interp list }
...
type vDFA = { vdfa_num_states : Big.big_int; vdfa_states : wf_states; vdfa_transition : vtransitions_t }
...
val gen_row' : wf_state -> Big.big_int -> wf_states -> token_id -> gen_row_ret_t
...
val coerce_transitions : wf_states -> wf_states -> transitions_t -> transitions_t

val cons_transition : Big.big_int -> wf_states -> entries_t -> transition_t

val build_table_func : (wf_states*(transitions_t*Big.big_int)) -> wf_states*transitions_t

val build_table : wf_states -> transitions_t -> Big.big_int -> wf_states*transitions_t
...
type naiveParserState = { rx_nps : rs_xf_pair; fixup_nps : (xt_interp -> interp) }

val rx_nps : xtype -> coq_type -> naiveParserState -> rs_xf_pair

val fixup_nps : xtype -> coq_type -> naiveParserState -> xt_interp -> interp

val naive_parse_token : naiveParserState -> token_id -> naiveParserState * interp list

val initial_naive_parser_state : grammar -> naiveParserState

type re_set_fixfn = xt_interp -> __ list

type instParserState = { dfa_ps : coq_DFA; row_ps : Big.big_int; fixup_ps : re_set_fixfn }
...
val parse_tokens : instParserState -> token_id list -> (token_id list * instParserState) * interp list

type vinstParserState = { vdfa_ps : vDFA; vrow_ps : Big.big_int; vfixup_ps : re_set_fixfn }
...
val compose_flat_map : ('a1 -> 'a2 list) -> ('a3 -> 'a1 list) -> 'a3 -> 'a2 list

val vparse_token : vinstParserState -> token_id -> vinstParserState*xt_interp list

val vps_extract_nil : vinstParserState -> __ list

val vparse_tokens : coq_type -> regexp -> vinstParserState -> token_id list -> (token_id list * vinstParserState) * interp list
