...
module X86_PARSER_ARG =
 struct
  ...
  let coq_Byte_t =
    BitVector_t (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ Big.zero)))))))

  (** val coq_Half_t : tipe **)

  let coq_Half_t =
    BitVector_t (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ
      (Big.succ Big.zero)))))))))))))))
  ...
  let coq_Fpu_Register_t =
    BitVector_t (Big.succ (Big.succ Big.zero))

  (** val coq_MMX_Register_t : tipe **)

  let coq_MMX_Register_t =
    BitVector_t (Big.succ (Big.succ Big.zero))
  ...
  let byte_explode b =
    let bs = Word.bits_of_Z (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ (Big.succ Big.zero)))))))) b in
    (bs (Big.doubleplusone (Big.doubleplusone Big.one))) :: ((bs (Big.double (Big.doubleplusone Big.one))) :: ((bs (Big.doubleplusone (Big.double
                                                                                                                 Big.one))) :: ((bs (Big.double (Big.double
                                                                                                                                  Big.one))) :: ((bs
                                                                                                                                                  (Big.doubleplusone
                                                                                                                                                  Big.one)) :: (
    (bs (Big.double Big.one)) :: ((bs Big.one) :: ((bs Big.zero) :: [])))))))
