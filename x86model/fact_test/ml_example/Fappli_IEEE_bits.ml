...
(** val join_bits : Big.big_int -> Big.big_int -> bool -> Big.big_int -> Big.big_int -> Big.big_int **)
...
(** val split_bits : Big.big_int -> Big.big_int -> Big.big_int -> (bool * Big.big_int) * Big.big_int **)
...
(** val bits_of_binary_float : Big.big_int -> Big.big_int -> binary_float -> Big.big_int **)
    ...
    let m =
      Z.sub mx
        (Big.z_case
           ...
           mw)
    in
    if Z.leb Big.zero m then join_bits mw ew sx m (Z.add (Z.sub ex emin) Big.one) else join_bits mw ew sx mx Big.zero)

(** val binary_float_of_bits_aux : Big.big_int -> Big.big_int -> Big.big_int -> full_float **)
...
(** val binary_float_of_bits : Big.big_int -> Big.big_int -> Big.big_int -> binary_float **)
